...
public class BoardController {
	...
	public void registGET() throws Exception{
		mylog.debug("/board/regist 호출 -> 페이지 이동");
	}
	...
	public String listPageGET(Criteria cri,HttpSession session, Model model) throws Exception{
		...
		pvo.setTotalCount(service.totalCnt()); // 작성되어있는 글의 개수
	...
	// @ModelAttribute : request.getParamater() 동작 -> Model 객체에 저장(1:n 관계)
	...
	public String modifyPOST(BoardVO vo, int bno,RedirectAttributes rttr) throws Exception{
		// 전달된 정보(수정할 정보) 저장
		mylog.debug(vo+"");
